...
df = pd.read_excel(r'C:\Users\GurmeetSingS\OneDrive - Informa plc\Personal\Self-development\Data Science\Python\PRO Project Management Dashboard\PRO_DB_Mock.xlsx',  sheet_name = ['PRO DB'])
